...
class Warp4JConfigurationTest {
  ...
  void testFindValidJdkDirectory_WhenNoArgumentIsProvidedAndApplicationIsNotPacketWithValidJdk_ThenJavaHomeIsUsed(VersionData versionData, boolean isOnlyFeatureVersion) throws URISyntaxException {
    // Given
