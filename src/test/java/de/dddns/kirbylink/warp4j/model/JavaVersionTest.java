...
class JavaVersionTest {
  ...
  class TestsForCompareToMethod {
    ...
    void compareTo_ShouldReturnNegative_WhenMajorIsLess() {
      // Given
      JavaVersion v1 = new JavaVersion(8, 0, 0, 0);
      JavaVersion v2 = new JavaVersion(11, 0, 0, 0);
    ...
    void compareTo_ShouldReturnPositive_WhenMajorIsGreater() {
      // Given
      JavaVersion v1 = new JavaVersion(17, 0, 0, 0);
      JavaVersion v2 = new JavaVersion(11, 0, 0, 0);
    ...
    void compareTo_ShouldReturnNegative_WhenMinorIsLess() {
      // Given
      JavaVersion v1 = new JavaVersion(17, 0, 0, 0);
      JavaVersion v2 = new JavaVersion(17, 1, 0, 0);
    ...
    void compareTo_ShouldReturnPositive_WhenPatchIsGreater() {
      // Given
      JavaVersion v1 = new JavaVersion(17, 0, 2, 0);
      JavaVersion v2 = new JavaVersion(17, 0, 1, 0);
    ...
    void compareTo_ShouldReturnNegative_WhenBuildIsLess() {
      // Given
      JavaVersion v1 = new JavaVersion(17, 0, 1, 6);
      JavaVersion v2 = new JavaVersion(17, 0, 1, 7);
    ...
    void compareTo_ShouldReturnZero_WhenAllFieldsAreEqual() {
      // Given
      JavaVersion v1 = new JavaVersion(17, 0, 1, 7);
      JavaVersion v2 = new JavaVersion(17, 0, 1, 7);
